...
# This script is (c) E. Branlard (2023) <https://github.com/OpenFAST/python-toolbox>

# The original Python script has been modified to allow a direct call, including arguments pass, 
# through LCO/St. No modification of the original code has been made.
...
file_    =  str(sys.argv[1]) # ex: '_AeroDyn_Changed.dat'
filename =  str(sys.argv[2]) # ex: '../data/NREL5MW/onshore/AeroDyn.dat' #
Key      =  str(sys.argv[3]) # ex: 'AirDens'
Value    =  sys.argv[4] # ex: 10.225
