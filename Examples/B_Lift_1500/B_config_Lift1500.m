%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%config-file for LCO/S (v1.8.3)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


save_project_name = "ContLift_1500";


%1. ================ Modification of the OpenFAST input files 

    selectModififyConfigFile = 0;
...
%3. ================ Wind Speed settings
	...
	wind_speed_x(1,:) = [13 13 13 13];
	wind_speed_t(1,:) = [0, 1000, 2000, 3000];
    wind_speed_x(2,:) = [12 12 12 12];
	wind_speed_t(2,:) = [0, 1000, 2000, 3000];
    wind_speed_x(3,:) = [14 14 14 14];
	wind_speed_t(3,:) = [0, 1000, 2000, 3000];
...
% SelectTrajectoryComputation = 0 / Definition A - Pitch trajectory definition for the Open-Loop
    ...
    Point_OpenLoop_Pitch_1 = 15;
    Point_OpenLoop_Pitch_2 = 15;
    Point_OpenLoop_Pitch_3 = 15;
...
lift_seg = 1; %240000;
    ...
    plot_1 = 0; % plot 1 - Wind1VelX + pitch angle #1 + Traj. Profile 
    plot_2 = 0; % plot 2 - GenPwr + Gen Tq + GenSpeed
    plot_3 = 0; % plot 3 - Azimuth + Ptfm angles
    plot_4 = 0; % plot 4 - Fl#1 + pitch angle 
    plot_5 = 1; % plot 5 - Fl#1 - Fl#2 - Fl#3
    plot_5b = 0; % plot 5b - Fl#1 + Fl#2 + Fl#3
    plot_6 = 0; % plot 6 - AVG Fl#1 + pitch angle
    plot_7 = 0; % plot 7 - pitch angle #1 - #2 - #3
    plot_8 = 0; % plot 8 - RootMyb #1 + blade pitch 
    plot_9 = 0; % plot 9 - RootMyb #1 - RootMyb #2 - RootMyb #3
    plot_10 = 0; % plot 10 - AVG Fl#1 - AVG Fl#2 - AVG Fl#3
    plot_11 = 0; % Cl_curves
...
%-------------------
InputSettings(cnt_Input,:) = ["GenDOF", "True"]; cnt_Input = cnt_Input + 1;% 
%-------------------
InputSettings(cnt_Input,:) = ["YawDOF", "False"]; cnt_Input = cnt_Input + 1;% 
%-------------------
InputSettings(cnt_Input,:) = ["TwFADOF1", "True"]; cnt_Input = cnt_Input + 1;%
%-------------------
InputSettings(cnt_Input,:) = ["TwFADOF2", "True"]; cnt_Input = cnt_Input + 1;%   
%-------------------
InputSettings(cnt_Input,:) = ["TwSSDOF1", "True"]; cnt_Input = cnt_Input + 1;% 
%-------------------
InputSettings(cnt_Input,:) = ["TwSSDOF2", "True"]; cnt_Input = cnt_Input + 1;% 
%-------------------
...
%-------------------
InputSettings(cnt_Input,:) = ["VSContrl", "4"]; cnt_Input = cnt_Input + 1;%
%-------------------
...
%9. ================ SIMULINK FILES
      ...
      ClosedLoop_SLXfile_Lift = 'ClosedLoop_Kernel_LiftCntrl_1A_2';
