...
%Example of closed-loop / lift control - IPC mode

save_project_name = "Example_lift_IPC";
...
%2. ================ Closed-loop Trajectories settings
    ...
    IPC_mode = 1; % select the IPC mode (only available if SelectTrajectoryComputation = 2)
...
% SelectTrajectoryComputation = 2 / Definition C - Pitch trajectory for Closed-Loop
    ...
    Point_ClosedLoop_Pitch_2 = 0.5;
    Point_ClosedLoop_Pitch_3 = 0.5;
