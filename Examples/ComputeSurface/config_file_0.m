...
%Example of open-loop / surface computing
save_project_name = "Example_surface";
...
%2. ================ Closed-loop Trajectories settings
    ...
    SelectTrajectoryComputation = 0; % open-loop / surface computing
...
% SelectTrajectoryComputation = 2 / Definition C - Pitch trajectory for Closed-Loop
    ...
    Point_ClosedLoop_Pitch_2 = 1;
    Point_ClosedLoop_Pitch_3 = 1;
...
ComputeSurface = 1; % surface computing enabled
