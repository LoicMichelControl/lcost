...
save_project_name = "OpenLoop_SurfaceComputation";


%%% Select the open-loop pitch (only for this config file):
...
% SelectTrajectoryComputation = 2 / Definition C - Pitch trajectory for Closed-Loop
    ...
    PitchBlade_0 = Openloop_pitch; % Initial Condition of the pitch
