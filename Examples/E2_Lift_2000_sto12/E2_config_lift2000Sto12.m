...
save_project_name = "ContLift_2000_sto13";
...
%-------------------
InputSettings(cnt_Input,:) = ["FileName_BTS", """TurbSim_12_TPO.bts"""]; % do not update the counter if this is the last item
