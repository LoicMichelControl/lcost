...
save_project_name = "ContLift_2000";
...
%3. ================ Wind Speed settings
	...
	wind_speed_x(1,:) = [13 13 13.5 13.5];
	wind_speed_t(1,:) = [0, 1000, 2000, 3000];
    wind_speed_x(2,:) = [12 12 12.5 12.5];
	wind_speed_t(2,:) = [0, 1000, 2000, 3000];
    wind_speed_x(3,:) = [14 14 14.5 14.5];
...
lift_seg = 240000;
    ...
    plot_6b = 1; % plot 6 - AVG Fl#1 + pitch angle
