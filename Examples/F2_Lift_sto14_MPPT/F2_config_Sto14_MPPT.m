...
save_project_name = "Example_lift_1500_sto13_MPPT";
...
%-------------------
InputSettings(cnt_Input,:) = ["VSContrl", "0"]; cnt_Input = cnt_Input + 1;%  4
%-------------------
...
% %-------------------
InputSettings(cnt_Input,:) = ["FileName_BTS", """TurbSim_14_TPO.bts"""]; % do not update the counter if this is the last item
...
%9. ================ SIMULINK FILES
      ...
      ClosedLoop_SLXfile_Lift = 'ClosedLoop_Kernel_LiftCntrl_1B'; % MPPT SLX file

      ClosedLoop_SLXfile_Lift_IPC = 'ClosedLoop_Kernel_Lift_IPCCntrl_1A'; %
